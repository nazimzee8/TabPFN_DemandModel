...
CREATE OR REPLACE TRANSIENT TABLE META_REGRESSION_DATASET_INDEX (
...
-- Execute ML Training Pipeline (Regression)
CALL build_meta_regression_dataset_index(FALSE, 1000);
...
CALL run_linear_regression_prep(FALSE, '2.5.0-py311', '2.5.0-py311', $AUTOGLUON_IMAGE_REF);
...
CALL run_linear_regression_deepset_evaluation(FALSE, '2.5.0-py311', '2.5.0-py311', $AUTOGLUON_IMAGE_REF);
ALTER COMPUTE POOL DEEPSET_GPU_POOL SUSPEND;
CALL run_linear_regression_baseline_evaluation(FALSE, '2.5.0-py311', '2.5.0-py311', $AUTOGLUON_IMAGE_REF, 6, 6);
ALTER COMPUTE POOL DEEPSET_CPU_POOL SUSPEND;
CALL run_linear_regression_autogluon_evaluation(FALSE, '2.5.0-py311', '2.5.0-py311', $AUTOGLUON_IMAGE_REF, 60);
ALTER COMPUTE POOL AUTOGLUON_CPU_POOL SUSPEND;
ALTER COMPUTE POOL DEEPSET_CPU_POOL RESUME;
CALL run_linear_regression_aggregation(FALSE, '2.5.0-py311', '2.5.0-py311', $AUTOGLUON_IMAGE_REF);
ALTER WAREHOUSE COMPUTE_WH SET AUTO_SUSPEND = 60;
