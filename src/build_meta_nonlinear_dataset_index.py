"""Build META_NONLINEAR_DATASET_INDEX from staged synthetic nonlinear parquet files.

This script is intended to run inside a Snowflake MLJob. It lists parquet files
under @META_NONLINEAR_DATASET_STAGE/{train,val,test}/, reads scalar metadata from
each payload inside the container, and rebuilds META_NONLINEAR_DATASET_INDEX in
Snowflake.
"""
...
META_DATASET_STAGE = "@META_NONLINEAR_DATASET_STAGE"
META_DATASET_INDEX = "META_NONLINEAR_DATASET_INDEX"
