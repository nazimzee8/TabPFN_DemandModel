...
CANONICAL_STAGE_PATH_TEMPLATE = (
    "{stage_root}/linear/regression/numeric/eval/{filename}"
)
...
CANONICAL_CLASSIFICATION_STAGE_PATH_TEMPLATE = (
    "{stage_root}/linear/classification/numeric/eval/{filename}"
)
...
#
# Single consolidated meta-dataset stage for all 8 training families.
# Stage layout:
#   @META_DATASET_STAGE/{linear|nonlinear}/{regression|classification}/{numeric|mixed}/{train,val,test}/<tid>.parquet
# ---------------------------------------------------------------------------

# ---- Consolidated training stage (all 8 families) ----
