...
@EVALUATION_DATASET_STAGE/nonlinear_classification_v1/, validates coverage
...
EVAL_STAGE_PREFIX  = "@EVALUATION_DATASET_STAGE/nonlinear_classification_v1"
CLS_MANIFEST_PATH  = f"{EVAL_STAGE_PREFIX}/nonlinear_classification_v1_manifest.json"
