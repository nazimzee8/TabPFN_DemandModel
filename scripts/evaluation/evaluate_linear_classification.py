"""
evaluate_linear_classification.py
===================================
MLJob worker entrypoint for synthetic classification evaluation.
...
SYNTHETIC_CLASSIFICATION_SUITE_ID      suite identifier (default: linear_classification_stat_aware)
...
SYNCLS_RESULTS_STAGE  = os.getenv("SYNCLS_RESULTS_STAGE", "@EVALUATION_RESULTS_STAGE/linear/classification/numeric/linear_classification_stat_aware")
...
# Guard: result path must contain /linear/classification/
assert "/linear/classification/" in SYNCLS_RESULTS_STAGE, (
    f"SYNCLS_RESULTS_STAGE must contain '/linear/classification/', got: {SYNCLS_RESULTS_STAGE!r}"
)
...
def _run_aggregate_mode(session) -> str:
    ...
    manifest = {
        ...
        "suite_schema_version": "linear_classification_eval_v1",
...
def main() -> None:
    ...
    print(f"[INFO] evaluate_linear_classification mode={mode} suite_id={SYNCLS_SUITE_ID}", flush=True)
