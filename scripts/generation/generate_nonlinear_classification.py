...
-----
    ...
    python scripts/generation/generate_nonlinear_classification.py \\
    ...
    # Smoke test:
    python scripts/generation/generate_nonlinear_classification.py --n-datasets 5 --dry-run

    # Core component only:
    python scripts/generation/generate_nonlinear_classification.py --suite-component core
...
def _generate_and_write(
    ...
    *,
    ...
    if is_mixed_categorical:
        ...
        # p_num = numeric feature count = p_signal + p_noise
...
def main() -> None:
    ...
    if args.mixed_categorical:
        ...
        stage_prefix = "@EVALUATION_DATASET_STAGE/nonlinear/classification/mixed/eval"
    else:
        ...
        stage_prefix = "@EVALUATION_DATASET_STAGE/nonlinear/classification/numeric/eval"
